...
export default function yesu({ sheetData }) {
  const filteredData = sheetData.filter((row) => row[0] === '여수');
  ...
  return (
    <>
      <Head>
        <title>여수 웨딩박람회 일정 안내 | 2025년 최신 업데이트</title>
        ...
        <meta property="og:title" content="여수 웨딩박람회 일정 안내 | 2025년 최신 업데이트" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "여수 지역의 2025년 최신 웨딩박람회 일정과 장소, 혜택을 한눈에 확인하세요.",
              "url": "https://wdkor.co.kr/yesu"
            })
          }}
        />
      </Head>
